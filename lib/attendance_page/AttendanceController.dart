...
class AttendanceController extends GetxController {
  ...
  RxDouble get attendancePercentage => attendanceController.attendancePercentage;
  ...
  Rx<AttendanceModel> get currentAttendance => attendanceController.currentAttendance;
  ...
  Future<void> checkIn() async {
    ...
    try {
      ...
      // Check if the check-in was actually recorded
      if (hasCheckedIn.value) {
        ...
        // Still not checked in after API call - strange situation
        // Try one more time to check status after a longer delay
        ...
        if (hasCheckedIn.value) {
          ...
          Get.snackbar(
            'Status Absen Tidak Jelas', 
            'Silakan refresh halaman untuk memeriksa status absen anda',
            snackPosition: SnackPosition.BOTTOM,
  ...
  String getCurrentDateFormatted() => attendanceController.getCurrentDateFormatted();
